...
class nbo:
    ...
    def get_data(self):
        ...
        for file_name in self.data.keys():
            ...
            if nbo_data != None:
                self.args.log.write(f"Reading information for NBO data from {file_name}\n")
    ...
    def parse_cc_data(self, file_name, file):
        ...
        except: setattr(cc_data, "bondorders", None)
        ...
        try: # grab individual Wiberg Bond Orders for each atom
            ...
            lines = outfile.readlines()
            for i,line in enumerate(lines):
                if line.find("Wiberg bond index matrix ") > -1: start_wiberg_ind = i+2
                if line.find("Wiberg bond index") > -1: end_wiberg_ind = i-1
        ...
        except: setattr(cc_data, "bondorders_matrix", None)
